<template>
  <div>
    <v-sheet>
      <v-card-title class="titles pt-10"
        >Informações Para Cadastro</v-card-title
      >
      <v-divider class="mt-5 mb-5"></v-divider>
      <v-card class="ml-5 mr-5 grey lighten-4 br br-3 elevation-5">
        <div class="mt-5">
          <form @submit.prevent="submit">
            ...
            <div>
              ...
              <div>
                ...
                <v-checkbox class="ml-2" required color="green">
