    ...
    <div>
      <form @submit.prevent="submit">
        ...
        <div>
          ...
          <v-btn @click.stop="sendform" :disabled="disable"> Contratar </v-btn>
        </div>
      </form>
    </div>
    <div>
      ...
      >
        <p class="p-alerts">
          Um email foi enviado para voce confirmando sua escolha, em breve um de
          nossos atendentes entrará em contato por meio dos dados fornecidos
        </p>
